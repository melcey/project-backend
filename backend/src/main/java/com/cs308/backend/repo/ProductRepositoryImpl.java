...
public class ProductRepositoryImpl implements ProductRepositoryObj {
    ...
    public void deleteProductsByManager(User productManager) {
        // Creates the query command to delete the products with the given product manager ID
    ...
    @Override
    public Optional<Product> updateProductName(Product product, String newName) {
    ...
    @Override
    public Optional<Product> updateProductModel(Product product, String newModel) {
    ...
    @Override
    public Optional<Product> updateProductSerialNumber(Product product, String newSerialNumber) {
    ...
    @Override
    public Optional<Product> updateProductDescription(Product product, String newDescription) {
    ...
    @Override
    public Optional<Product> updateProductQuantityInStock(Product product, int newQuantityInStock) {
    ...
    @Override
    public Optional<Product> updateProductPrice(Product product, BigDecimal newPrice) {
    ...
    @Override
    public Optional<Product> updateProductWarrantyStatus(Product product, String newWarrantyStatus) {
    ...
    @Override
    public Optional<Product> updateProductDistributorInfo(Product product, String newDistributorInfo) {
    ...
    @Override
    public Optional<Product> updateProductIsActive(Product product, boolean newIsActive) {
    ...
    @Override
    public Optional<Product> updateProductImageUrl(Product product, String newImageUrl) {
    ...
    @Override
    public Optional<Product> updateProductCategory(Product product, Category newCategory) {
    ...
    @Override
    public Optional<Product> updateProductManager(Product product, User newProductManager) {
