...
public class CartItemResponse {
    ...
    public CartItemResponse(Long id, Long cartId, ProductResponse product, int quantity, BigDecimal priceAtAddition) {
        this.id = id;
        this.cartId = cartId;
    ...
    public String toString() {
        ...
        builder.append("CartItemResponse [id=").append(id)
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        CartItemResponse other = (CartItemResponse) obj;
        if (id == null) {
            if (other.id != null)
                return false;
